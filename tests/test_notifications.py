from bluesky_social.notifications import (
    get_notifications,
    get_responses,
...
class DummyClient:
    def __init__(self):
            ...
            post = type(
                ...
                (),
                {
                    "post": type(
                        ...
                        (),
                        {
                            "record": type("obj", (), {"text": "post text"}),
                            "uri": "uri_post",
                        },
                    ),
                    "reply_count": 1,
        ...
        self.app.bsky.notification = type(
            "obj", (), {"list_notifications": list_notifications}
        )
        self.app.bsky.feed = type(
            "obj",
            (),
            {"get_post_thread": get_post_thread, "get_author_feed": get_author_feed},
        )
