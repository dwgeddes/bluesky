...
from .notifications import get_notifications, list_unanswered_responses, list_posts_and_responses

# Configure logging
logging.basicConfig(level=logging.ERROR, format='%(asctime)s - %(levelname)s - %(message)s')

# Default service name and username
...
def main() -> None:
    ...
    parser.add_argument("--list-posts", action="store_true", help="List your posts and their responses")
    parser.add_argument("--username", type=str, help=f"BlueSky username (default: {DEFAULT_USERNAME})", 
